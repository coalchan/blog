---
title: Scala之旅——统一类型
date: 2018-07-23 23:18:03
categories: [翻译]
tags: [scala]
description: 原文：https://docs.scala-lang.org/tour/unified-types.html
---
...
型。它定义了一些通用的方法如`equals`、`hashCode`和`toString`。`Any`有两个直接子类：`AnyVal`和`AnyRef`。<!--more-->
